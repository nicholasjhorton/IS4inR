...
tally(~ activity + area, margins = TRUE, data = area1)
```

```{r fig.height = 5}
vcd::mosaic(tally(~ activity + area, data = area1), main = "Mosaicplot of Activity by area",
  shade = TRUE, ylab = "Area", xlab = "Activity")
xchisq.test(tally(~ activity + area, data = area1))
```
