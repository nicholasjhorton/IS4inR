...
The summary statistics at the bottom of page 705 can be calculated using `df_stats()`.
...
A box plot of the residuals shown by figure 24.5 on page 715 can be generated with the `gf_boxplot()` function. Figure 24.6 is made using the `gf_qq` function.
