...
twohund<-as.vector(c(23.2,23.3,23.3,23.6,23.9,23.9,24.2,24.2,24.3,
                     24.3,24.3,24.3,24.3,24.4,24.5,24.5,24.6,24.6,24.6,24.7,24.7,24.9,
                     24.9,24.9,25.0,25.0,25.0,25.2,25.3,25.4,25.4,25.4,25.4,25.5,25.9,
                     25.9,26.1))
...
```
```{r}
gf_histogram(..density..~ mpg, binwidth=1, center=0.5, data=Nissan, fill = "royalblue2", col=TRUE)
