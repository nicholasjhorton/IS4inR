...
options(na.rm=TRUE)
options(digits=3)
(6.54-5.91)/0.56  # Dobrynska's jump was 2.18 SD's greater than the mean
```

```{r}
twohund<-as.vector(c(23.2,23.3,23.3,23.6,23.9,23.9,24.2,24.2,24.3,24.3,24.3,24.3,24.3,24.4,24.5,24.5,24.6,24.6,24.6,24.7,24.7,24.9,24.9,24.9,25.0,25.0,25.0,25.2,25.3,25.4,25.4,25.4,25.4,25.5,25.9,25.9,26.1))
...
read_delim("http://www.amherst.edu/~nhorton/sdm4/data/Nissan.txt",
  delim="\t")
gf_histogram(~ mpg, binwidth=1, center=0.5, data=Nissan, fill = "navy", col=TRUE)
